...
set_property PACKAGE_PIN Y10 [get_ports {motorB[1]}];#Motor Stuff
set_property PACKAGE_PIN W12 [get_ports {motorA[3]}];
set_property PACKAGE_PIN W11 [get_ports {motorA[2]}];
set_property PACKAGE_PIN V10 [get_ports {motorA[1]}];
set_property PACKAGE_PIN W8 [get_ports {motorA[0]}];
...
#Light Sensor
set_property PACKAGE_PIN W7 [get_ports {cs}];
set_property IOSTANDARD LVCMOS33 [get_ports cs];
...
set_property PACKAGE_PIN V22 [get_ports {C0}];
set_property IOSTANDARD LVCMOS33 [get_ports C0]

set_property PACKAGE_PIN W22 [get_ports {D0}];
